            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>
                        Editar tarefa <a href="index.php" class="btn btn-danger float-end">Voltar</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        <?php
                        ...
                        <form action="acoes.php" method="POST">
                            ...
                            <div class="mb-3">
                                <button type="submit" name="editar_tarefa" class="btn btn-primary float-end">Editar</button>
                            </div>
                        </form>
                        <?php
                        else:
